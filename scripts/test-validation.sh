...
echo "╔═══════════════════════════════════════════╗"
echo "║   Waycast Validation Test Suite          ║"
...
echo "=========================================="
cargo test --package waycast-rtsp --test spec_compliance -- --nocapture --test-threads=1
...
echo "===================================="
cargo test --package waycast-daemon --test session_simulation -- --nocapture --test-threads=1
...
echo "================================"
cargo test --package waycast-net --test network_tests -- --nocapture --test-threads=1
...
echo "================================"
cargo test --package waycast-rtsp --test protocol_tests -- --nocapture --test-threads=1
...
echo "=============================="
cargo test --package waycast-rtsp --test integration_tests -- --nocapture --test-threads=1
